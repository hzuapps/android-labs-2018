...
public class tianjiaMainActivity extends AppCompatActivity {

    // @Override
    // protected void onCreate(Bundle savedInstanceState) {
    // super.onCreate(savedInstanceState);
    // setContentView(R.layout.activity_tianjia_main);
    // }
    //String tex;
    ...
    public static final String TAG = tianjiaMainActivity.class.getSimpleName();
    ...
    private void showResult(String result) {
        ((TextView) findViewById(R.id.editText3)).setText(result);
    }
