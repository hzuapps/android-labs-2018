...
public class Soft1614080902328Activity3 extends AppCompatActivity {
    String text;
    String Name;
    String id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soft16140809023283);
        getJson();
    }
    public void getJson() {
        new Thread() {
            ...
            public void run() {
                try {
                    String url_user = "https://raw.githubusercontent.com/liangzhuoh/android-labs-2018/master/soft1614080902328/lalala.json";
