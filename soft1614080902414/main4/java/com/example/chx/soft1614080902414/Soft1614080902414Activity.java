package com.example.chx.soft1614080902414;
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.btn_save:
                    ...
                    Toast.makeText(Soft1614080902414Activity.this,"数据保存成功",Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btn_read:
                    String content="";
                    try {
                    ...
                    Toast.makeText(Soft1614080902414Activity.this,"保存的数据是"+content,Toast.LENGTH_SHORT).show();
                    break;
                default:
            }
        }
