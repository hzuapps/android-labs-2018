...
public class Download extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSave = (Button)findViewById(R.id.button_download);
        editText = (EditText)findViewById(R.id.url);

        mBtnSave.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
                new Thread(connectNet).start();
                mSaveDialog = ProgressDialog.show(Download.this, "保存图片", "图片正在保存中，请稍等...", true);
    ...
    private final ThreadLocal<Runnable> saveFileRunnable = new ThreadLocal<Runnable>() {
        @Override
    ...
    private Handler messageHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(Download.this, mSaveMessage, Toast.LENGTH_SHORT).show();
        }
    };
        ...
        public void run() {
            try {
                ...
                if(data!=null){
                    ...
                    Toast.makeText(Download.this, "Image error!", 1).show();
                }
                // 发送消息，通知handler在主线程中更新UI
                connectHanlder.sendEmptyMessage(0);
                Log.d(TAG, "set image ...");
            } catch (Exception e) {
                Toast.makeText(Download.this,"无法链接网络！", 1).show();
                e.printStackTrace();
            }
