...
public class TextMainActivity extends Activity{
        ...
        public static final String TAG = TextMainActivity.class.getSimpleName();
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                ((Button) findViewById(R.id.button_insave)).setOnClickListener(new View.OnClickListener() {
                        @Override
                ...
                ((Button) findViewById(R.id.button_exsave)).setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                                String text = ((EditText) findViewById(R.id.editText1)).getText().toString();
