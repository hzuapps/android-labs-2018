    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                Intent intent=new Intent(Soft1614080902327Activity.this,SecondActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_setbk:
                ...
                intent.setClass(Soft1614080902327Activity.this,ThirdActivity.class);
                startActivity(intent);
                Soft1614080902327Activity.this.finish();
                break;
        }
