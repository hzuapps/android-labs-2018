...
++ +
++ +<resources>
++ +    <string name="app_name">Soft1614080902327Activity餐厅点餐管理系统</string>
++ +</resources>
++ +
++ ++## 4.实验体会
++ +  本次实验使我对使用GitHub平台更加熟悉，同时也更了解Andriod Studio的运用。在课堂上获知了andriod开发和java开发的不同点，如Android程序里没有main方法。