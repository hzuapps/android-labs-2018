    ...
    public void getJson(){
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    //文件的URL
                    String url_s="https://raw.githubusercontent.com/xiaoshanshanlin/android-labs-2018/master/soft1606081301233/Text.json";
