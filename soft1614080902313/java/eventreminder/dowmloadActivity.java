...
public class dowmloadActivity extends AppCompatActivity  implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dowmload);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.content:
                ...
                new Task().execute("http://pic.58pic.com/58pic/16/06/72/87a58PICWRj_1024.jpg");
                break;
