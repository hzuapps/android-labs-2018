...
public class M3Activity extends AppCompatActivity  implements OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.content:
                ...
                new Task().execute("http://book.100xuexi.com/bookpics/20150213102115268_Daly.jpg");
                break;
