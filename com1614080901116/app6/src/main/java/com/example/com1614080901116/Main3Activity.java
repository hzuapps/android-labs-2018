    ...
    public void getJson(){
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    //文件的URL
                    String url_s="https://raw.githubusercontent.com/zero297217464/android-labs-2018/master/com1614080901116/Test.json";
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        adapter= new ArrayAdapter<>(Main3Activity.this, android.R.layout.simple_list_item_1, list);
    ...
    public void parseJson(){
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                String movie=thing.getString("quanshu");
                String address=thing.getString("address");
                String time=thing.getString("time");
                String msg;
                msg=movie+"     "+address+"     "+time;
                Log.v("结果",msg);
                list.add(msg);
            }
