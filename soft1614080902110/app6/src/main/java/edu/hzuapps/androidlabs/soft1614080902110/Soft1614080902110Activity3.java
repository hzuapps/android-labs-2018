package edu.hzuapps.androidlabs.soft1614080902110;
...
public class Soft1614080902110Activity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soft16140809021103);
        getJson();
    }
    public void getJson() {
        new Thread() {
            ...
            public void run() {
                try {
                    String url_user = "https://raw.githubusercontent.com/ccccssxxxx/android-labs-2018/master/soft1614080902110/MIKE.json";
