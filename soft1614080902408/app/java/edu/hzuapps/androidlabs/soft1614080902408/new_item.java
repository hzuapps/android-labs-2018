...
public class new_item extends AppCompatActivity {
    ...
    public static final String TAG = new_item.class.getSimpleName();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button) findViewById(R.id.addButton)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String text = ((EditText) findViewById(R.id.title_text)).getText().toString();
    ...
    private void showResult(String result) {
        ...
        ((TextView) findViewById(R.id.fenlei_text)).setText(result.toCharArray(), 0, result.length());
